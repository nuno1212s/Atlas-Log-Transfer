...
pub fn metrics() -> Vec<MetricRegistry> {
    vec![
        (LOG_TRANSFER_LOG_CLONE_TIME_ID, LOG_TRANSFER_LOG_CLONE_TIME.to_string(), MetricKind::Duration, MetricLevel::Info).into(),
        (LOG_TRANSFER_PROOFS_CLONE_TIME_ID, LOG_TRANSFER_PROOFS_CLONE_TIME.to_string(), MetricKind::Duration, MetricLevel::Info).into(),
    ]
}